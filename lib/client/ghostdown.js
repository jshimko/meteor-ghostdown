...
Meteor.startup(function() {
  Session.setDefault(editor-markdown, '');
  Session.setDefault(editor-html, '');
  Session.setDefault(editor-word-count, '');
})
...
Template.GhostEditor.destroyed = function () {
  ...
  Session.set(editor-html, '');
  Session.set(editor-word-count, '');
};